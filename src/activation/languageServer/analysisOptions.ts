...
import { workspace, ProvideCompletionItemsSignature, LanguageClientOptions, ConfigurationChangeEvent, OutputChannel } from 'coc.nvim'
import { CancellationToken, CompletionContext, Disposable, Event, Emitter, Position, TextDocument } from 'vscode-languageserver-protocol'
...
export class LanguageServerAnalysisOptions implements ILanguageServerAnalysisOptions {
  ...
  public async getAnalysisOptions(): Promise<LanguageClientOptions> {
    ...
    const documentSelector = [
      ...
      ; (documentSelector[0] as any).pattern = `${workspace.rootPath}/**/*`
