...
export abstract class BaseDiagnosticsService implements IDiagnosticsService {
  ...
  protected getDiagnosticsKey(diagnostic: IDiagnostic): string {
    ...
    const workspaceFolder = diagnostic.resource ? workspace.workspaceFolder : undefined
    return `${diagnostic.code}dbe75733-0407-4124-a1b2-ca769dc30523${workspaceFolder ? workspace.rootPath : ''}`
  }
}
